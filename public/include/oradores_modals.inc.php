        ...
        <div class="row">
            ...
            <div class="span3">
                <p>
                    ...
                    cada vez peor código, y, peor aún, poniendo ese código en producción.
                </p>
                <p>
                    Ha trabajado con Ruby, python, php, JavaScript, y haciéndose pasar por
                    diseñador (sin mucho éxito). Hoy en día trabaja en GitHub haciendo
                    muchos deploys por día y nos va a contar un poco de cómo GitHub hace
                    decenas de deploys a producción por día sin que nadie se entere.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="span3">
                ...
                <p>
                    Le gusta aprender, crear y diseñar soluciones. Si bien es adicto al trabajo, intenta mantener un equilibrio entre lo profesional y lo personal.
                </p>
                <p>
                    Cree firmemente que la calidad debe de estar presente en cada una de nuestras actividades.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="span3">
                ...
                <p>
                    Desarrolla proyectos Web utilizando distintas tecnologías teniendo más de seis años de experiencia en el rubro.
                </p>
            </div>
        </div>
    </div>
