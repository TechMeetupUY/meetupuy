                ...
                <div class="row">
                    <div class="span12">
                        <p>
                            ...
                            Para hacerlo simple creamos los siguientes paquetes. Si tenés alguna idea u otra forma de apoyar mandanos 
                    ...
                    <div class="span4">
                        <div class="product-plan">
                            <ul class="unstyled plans">
                                ...
                                <li>
                                    <div class="feature">
                                        <h4><i class="icon-star"></i> Logo (chico) en la web.</h4>
                                    </div>				
                                </li>			
                                <li>
                                    <div class="feature">
                                ...
                                <li>
                                    <div class="action">
                                        <a href="mailto:info@meetup.uy?subject=MeetupUy Auspicio - Bronce" class="btn btn-primary btn-action">Seleccionar</a>
                                    </div>				
                                </li>				
                            </ul>
                        </div>  
                    ...
                    <div class="span4">
                        <div class="product-plan">
                            <ul class="unstyled plans">
                                ...
                                <li>
                                    <div class="action">
                                        <a href="mailto:info@meetup.uy?subject=MeetupUy Auspicio - Plata" class="btn btn-primary btn-action">Seleccionar</a>
                                    </div>				
                                </li>				
                            </ul>
                        </div>  
                    ...
                    <div class="span4">
                        <div class="product-plan">
                            <ul class="unstyled plans">
                                ...
                                <li>
                                    <div class="feature">
                                        <h4><i class="icon-star"></i> Logo (grande) en la web.</h4>
                                    </div>				
                                </li>			
                                <li>
                                    <div class="feature">
                                ...
                                <li>
                                    <div class="feature">
                                        <h4><i class="icon-comment"></i> 15 minutos entre charlas en el horario de la tarde.</h4>
                                    </div>				
                                </li>
                                <li>
                                    <div class="action">
                                        <a href="mailto:info@meetup.uy?subject=MeetupUy Auspicio - Oro" class="btn btn-primary btn-action">Seleccionar</a>
                                    </div>				
                                </li>				
                            </ul>
                        </div>  
